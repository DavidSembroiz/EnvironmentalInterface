...
public class XM1000Listener implements MessageListener {

        private File f;
        private Utils uts;
        private Database awsdb;

        public XM1000Listener(Database awsdb) {
            this.awsdb = awsdb;
        }
        ...
        public JSONObject parseMessage(Message message) {
            ...
            try {
                ...
                double batt = msg.get_batt() / 100.0;
		        ...
		        System.out.println("Temperature: " + Double.toString(tempVal));
		        ...
		        System.out.println("Battery: " + Double.toString(batt) + "V");
